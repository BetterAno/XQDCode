...
createConstructor('Document', true, [], {
    createElement: function (Tag_name) {
        ...
        // return {}
        // return watch({}, Tag_name)
        return watch({classList: {}}, Tag_name)
    },
...
// document 中的属性
createConstructor('HTMLHtmlElement', true, [], {}, 'HTMLDocument')
...
document = watch(new HTMLDocument({
    // all: new HTMLAllCollection(null, null, CONSTRUCTOR_TOKEN),
...
}, null, CONSTRUCTOR_TOKEN), 'document')    // 属性 方法 关闭严格模式
