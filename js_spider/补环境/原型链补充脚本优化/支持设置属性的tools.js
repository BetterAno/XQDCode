...
createConstructor('Navigator', true, [{
        ...
        // targetClass: 'Navigator'  // 设置属性所属的类, 如果是属于这个类的属性，则不需要设置 targetClass
    }],
    {}, {})
...
console.log(Object.getOwnPropertyDescriptor(navigator.__proto__, "userAgent"));
