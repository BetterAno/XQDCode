...
createConstructor('EventTarget', true, [], {
    ...
    //     console.log('EventTarget.addEventListener添加的事件:', type, listener)
    // }
}, {})
createConstructor('Node', true, [], {
    // appendChild: function (element) {
    //     console.log('Node.appendChild添加的元素:', element)
    // },
    // removeChild: function (element) {
    //     console.log('Node.removeChild删除的元素:', element)
    // }
}, 'EventTarget')
...
script = {
    getAttribute: function (attr) {
        console.log('script.getAttribute获取的属性:', attr)
        if (attr === 'r') {
            return 'm'
        }
    },
    parentElement: {
        removeChild: function (element) {
            console.log('script.parentNode.removeChild删除的元素:', element)
        }
    },
    innerText: ''
}
...
createConstructor('Document', true, [], {
    ...
    getElementById: function (id) {
        console.log('Document.getElementById获取的id:', id)
        // if (id === 'FbkwzLN5XOx0'){
        // content="EMpb6e6hSv.bXKRDUF4XkBvN.z.thGhMvYYotsN0E6ERMpMnJZwlmsMQfsCkpdEGIJJ_rAf3l_pCjZU2otJwiHpuM3OJcTDJ8h9ub23QDgES0zIRqFufco_Yj.u1rwWXm5uAYtJ822h.J5XtUFRma0Y.F8Vvh0ujkrIYyH2EUbRnIPxm0W.fMyegxmQpCXQTR01WeiuJM0Z"
        // return ('<meta id="FbkwzLN5XOx0" content="EMpb6e6hSv.bXKRDUF4XkBvN.z.thGhMvYYotsN0E6ERMpMnJZwlmsMQfsCkpdEGIJJ_rAf3l_pCjZU2otJwiHpuM3OJcTDJ8h9ub23QDgES0zIRqFufco_Yj.u1rwWXm5uAYtJ822h.J5XtUFRma0Y.F8Vvh0ujkrIYyH2EUbRnIPxm0W.fMyegxmQpCXQTR01WeiuJM0Z" r="m">')
        // }
    }
}, 'Node')
