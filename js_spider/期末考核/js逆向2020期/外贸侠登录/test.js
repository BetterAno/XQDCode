...
captcha_key = '536508ed236033cb388b3455243cc18d'
const go = new Go()
WebAssembly.instantiate(wasmCode, go.importObject).then(result => {
    var instance = result.instance;
    go.run(instance);
    console.log(go._makeFuncWrapper(1)(password, token, captcha_key, "", "", ""))
})
