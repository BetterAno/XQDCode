...
/* 设置属性 */
// 方式一: 设置普通属性
const propertySetter = function (instance) {
    // 将属性设置在原型上，而非实例上
    instance.constructor.prototype.userAgent = 'abc';

    // 或者更明确地指定(包含描述符信息)
    /*Object.defineProperty(instance.constructor.prototype, 'userAgent', {
        value: 'abc',
        writable: true,
        enumerable: true,
        configurable: true
...
/*
* 创建的类进行实例化的过程中，可以传递三个参数
*   参数1: object {UserAgent: xxx} 如果直接传递对象, 则会将这个对象中的属性信息复制给实例对象
*   参数2: function 通过函数的方式赋值属性可以指定原型
*   参数3: token验证, 允许通过new的方式创建对象
*  */
navigator_1 = watch(new Navigator(null, propertySetter, CONSTRUCTOR_TOKEN), 'navigator')
console.log(navigator_1.userAgent)
console.log('原型信息打印:', Object.getOwnPropertyDescriptor(navigator_1.__proto__, "userAgent"));

console.log('-'.repeat(30))

// 方式二: 设置带有描述符的属性
const propertySetterWithDescriptors = function(instance) {
    Object.defineProperty(instance, '只读属性', {
        value: '这是一个自定义的只读属性...',
        writable: false,
        enumerable: true,
        configurable: false
    ...
    Object.defineProperty(instance, '可操作属性', {
        get: function() { return this._internalValue || '这是一个自定义的可操作属性...'; },
        set: function(val) { this._internalValue = val.toUpperCase(); },
        enumerable: true,
        configurable: true
    });
};
navigator_2 = watch(new Navigator(null, propertySetterWithDescriptors, CONSTRUCTOR_TOKEN), 'navigator')
console.log(navigator_2.只读属性)
console.log(navigator_2.可操作属性)

console.log('-'.repeat(30))

// 示例三: 结合element参数使用
const SomeConstructor = createConstructor(
    'SomeConstructor',
    true,
    [],
    {},
    {});
const element = { name: 'John', age: 30 };
const complexPropertySetter = function(instance) {
    // 添加计算属性
...
const person = watch(new SomeConstructor(element, complexPropertySetter, CONSTRUCTOR_TOKEN), 'person')
