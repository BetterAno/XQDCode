...
WebGLRenderingContext = v_saf(function WebGLRenderingContext() {
    ...
    this.getParameter = function (key) {
        ...
        if (this._toggle[key]) {
            ...
            if (key == 37446) {
                return "ANGLE (NVIDIA, NVIDIA GeForce GTX 1050 Ti Direct3D11 vs_5_0 ps_5_0, D3D11-27.丰巢官网登录.14.5671)"
            }
        } else {
            if (key == 33902) {
...
ReadableStreamDefaultReader = v_saf(function ReadableStreamDefaultReader() {
    if (!v_new_toggle) {
        throw TypeError("Illegal constructor")
    }
    ;
...
ReadableStreamDefaultController = v_saf(function ReadableStreamDefaultController() {
    if (!v_new_toggle) {
        throw TypeError("Illegal constructor")
    }
    ;
})
FinalizationRegistry = v_saf(function FinalizationRegistry() {
    if (!v_new_toggle) {
        throw TypeError("Illegal constructor")
    }
    ;
...
EventCounts = v_saf(function EventCounts() {
    if (!v_new_toggle) {
        throw TypeError("Illegal constructor")
    }
    ;
})
Scheduler = v_saf(function Scheduler() {
    if (!v_new_toggle) {
        throw TypeError("Illegal constructor")
    }
    ;
})
LayoutShiftAttribution = v_saf(function LayoutShiftAttribution() {
    if (!v_new_toggle) {
        throw TypeError("Illegal constructor")
    }
    ;
...
VideoFrame = v_saf(function VideoFrame() {
    if (!v_new_toggle) {
        throw TypeError("Illegal constructor")
    }
    ;
...
IDBFactory = v_saf(function IDBFactory() {
    if (!v_new_toggle) {
        throw TypeError("Illegal constructor")
    }
    ;
...
CanvasGradient = v_saf(function CanvasGradient() {
    if (!v_new_toggle) {
        throw TypeError("Illegal constructor")
    }
    ;
})
SVGRect = v_saf(function SVGRect() {
    if (!v_new_toggle) {
        throw TypeError("Illegal constructor")
    }
    ;
...
MediaStream = v_saf(function MediaStream() {
    ;
});
_inherits(MediaStream, EventTarget)
MediaStreamTrack = v_saf(function MediaStreamTrack() {
    if (!v_new_toggle) {
        throw TypeError("Illegal constructor")
    }
    ;
});
_inherits(MediaStreamTrack, EventTarget)
...
webkitMediaStream = v_saf(function webkitMediaStream() {
    ;
});
_inherits(webkitMediaStream, EventTarget)
...
ScreenOrientation = v_saf(function ScreenOrientation() {
    if (!v_new_toggle) {
        throw TypeError("Illegal constructor")
    }
    ;
});
_inherits(ScreenOrientation, EventTarget)
...
IDBRequest = v_saf(function IDBRequest() {
    if (!v_new_toggle) {
        throw TypeError("Illegal constructor")
    }
    ;
});
_inherits(IDBRequest, EventTarget)
...
MediaStreamTrackGenerator = v_saf(function MediaStreamTrackGenerator() {
    if (!v_new_toggle) {
        throw TypeError("Illegal constructor")
    }
    ;
});
_inherits(MediaStreamTrackGenerator, MediaStreamTrack)
...
MediaStreamAudioDestinationNode = v_saf(function MediaStreamAudioDestinationNode() {
    if (!v_new_toggle) {
        throw TypeError("Illegal constructor")
    }
    ;
});
_inherits(MediaStreamAudioDestinationNode, AudioNode)
...
AudioDestinationNode = v_saf(function AudioDestinationNode() {
    if (!v_new_toggle) {
        throw TypeError("Illegal constructor")
    }
    ;
});
_inherits(AudioDestinationNode, AudioNode)
...
IDBOpenDBRequest = v_saf(function IDBOpenDBRequest() {
    if (!v_new_toggle) {
        throw TypeError("Illegal constructor")
    }
    ;
});
_inherits(IDBOpenDBRequest, IDBRequest)
...
AudioBufferSourceNode = v_saf(function AudioBufferSourceNode() {
    if (!v_new_toggle) {
        throw TypeError("Illegal constructor")
    }
    ;
});
_inherits(AudioBufferSourceNode, AudioScheduledSourceNode)
...
Object.defineProperties(Navigator.prototype, {
    userAgent: {
        get() {
            v_console_log("  [*] Navigator -> userAgent[get]", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36 Edg/138.0.0.0");
    ...
    appVersion: {
        get() {
            v_console_log("  [*] Navigator -> appVersion[get]", "5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36 Edg/138.0.0.0");
            return "5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36 Edg/138.0.0.0"
        }
    },
    vendor: {
        get() {
...
Object.defineProperties(PerformanceEntry.prototype, {
    duration: {
        get() {
            v_console_log("  [*] PerformanceEntry -> duration[get]", 5);
            return 5
        }
    },
    name: {
        get() {
            v_console_log("  [*] PerformanceEntry -> name[get]", "self");
            return "self"
        }
    },
    startTime: {
        get() {
            v_console_log("  [*] PerformanceEntry -> startTime[get]", 34467.39999999851);
            return 34467.39999999851
        }
    },
    entryType: {
        get() {
...
Object.defineProperties(Event.prototype, {
    ...
    type: {
        get() {
            v_console_log("  [*] Event -> type[get]", "copy");
            return "copy"
        }
    },
    timeStamp: {
        get() {
            v_console_log("  [*] Event -> timeStamp[get]", 37805);
            return 37805
        }
    },
    stopImmediatePropagation: {
        value: v_saf(function stopImmediatePropagation() {
            v_console_log("  [*] Event -> stopImmediatePropagation[func]", [].slice.call(arguments));
        })
    },
    currentTarget: {
        get() {
...
Object.defineProperties(URLSearchParams.prototype, {
    ...
    append: {
        value: v_saf(function append() {
            v_console_log("  [*] URLSearchParams -> append[func]", [].slice.call(arguments));
        })
    },
    set: {
    ...
    entries: {
        value: v_saf(function entries() {
            v_console_log("  [*] URLSearchParams -> entries[func]", [].slice.call(arguments));
        })
    },
...
Object.defineProperties(HTMLAllCollection.prototype, {
    length: {
        get() {
            v_console_log("  [*] HTMLAllCollection -> length[get]", 435);
            return 435
        }
    },
...
Object.defineProperties(NodeList.prototype, {
    length: {
        get() {
            v_console_log("  [*] NodeList -> length[get]", 21);
            return 21
        }
    },
...
Object.defineProperties(webkitURL.prototype, {
    ...
    pathname: {
        get() {
            v_console_log("  [*] webkitURL -> pathname[get]", "/61306980056");
            return "/61306980056"
        }, set() {
    ...
    href: {
        get() {
            v_console_log("  [*] webkitURL -> href[get]", "https://mcs.zijieapi.com/list?aid=6383&sdk_version=5.1.23_dy&device_platform=web");
            return "https://mcs.zijieapi.com/list?aid=6383&sdk_version=5.1.23_dy&device_platform=web"
        }
    },
    username: {
        get() {
    ...
    host: {
        get() {
            v_console_log("  [*] webkitURL -> host[get]", "mcs.zijieapi.com");
            return "mcs.zijieapi.com"
        }
    },
    hash: {
        get() {
    ...
    hostname: {
        get() {
            v_console_log("  [*] webkitURL -> hostname[get]", "live.douyin.com");
    ...
    search: {
        get() {
            v_console_log("  [*] webkitURL -> search[get]", "?recommend=1&recommend=1&recommend=1");
            return "?recommend=1&recommend=1&recommend=1"
        }, set() {
    ...
    origin: {
        get() {
            v_console_log("  [*] webkitURL -> origin[get]", "https://helpdesk.bytedance.com");
            return "https://helpdesk.bytedance.com"
        }
    },
...
Object.defineProperties(Response.prototype, {
    ...
    body: {
        get() {
            v_console_log("  [*] Response -> body[get]", {});
            return {}
        }
    },
...
Object.defineProperties(Headers.prototype, {
    entries: {
        value: v_saf(function entries() {
            v_console_log("  [*] Headers -> entries[func]", [].slice.call(arguments));
        })
    },
    forEach: {
        value: v_saf(function forEach() {
            v_console_log("  [*] Headers -> forEach[func]", [].slice.call(arguments));
        })
    },
...
Object.defineProperties(MutationRecord.prototype, {
    type: {
        get() {
            v_console_log("  [*] MutationRecord -> type[get]", "attributes");
            return "attributes"
        }
    },
    attributeName: {
        get() {
            v_console_log("  [*] MutationRecord -> attributeName[get]", "class");
            return "class"
        }
    },
    oldValue: {
        get() {
            v_console_log("  [*] MutationRecord -> oldValue[get]", "douyin-player douyin-player-controls-autohide kwuig84h");
            return "douyin-player douyin-player-controls-autohide kwuig84h"
        }
    },
...
Object.defineProperties(VideoPlaybackQuality.prototype, {
    droppedVideoFrames: {
        get() {
            v_console_log("  [*] VideoPlaybackQuality -> droppedVideoFrames[get]", 6);
            return 6
        }
    },
    totalVideoFrames: {
        get() {
            v_console_log("  [*] VideoPlaybackQuality -> totalVideoFrames[get]", 588);
            return 588
        }
    },
    [Symbol.toStringTag]: {value: "VideoPlaybackQuality", writable: false, enumerable: false, configurable: true},
})
...
Object.defineProperties(NavigatorUAData.prototype, {
    mobile: {
        get() {
            v_console_log("  [*] NavigatorUAData -> mobile[get]", false);
            return false
        }
    },
    brands: {
    ...
    getHighEntropyValues: {
        value: v_saf(function getHighEntropyValues() {
            v_console_log("  [*] NavigatorUAData -> getHighEntropyValues[func]", [].slice.call(arguments));
        })
    },
...
Object.defineProperties(DOMRectReadOnly.prototype, {
    left: {
        get() {
            v_console_log("  [*] DOMRectReadOnly -> left[get]", 0);
            return 0
        }
    },
    top: {
        get() {
            v_console_log("  [*] DOMRectReadOnly -> top[get]", 889.25);
            return 889.25
        }
    },
    right: {
        get() {
            v_console_log("  [*] DOMRectReadOnly -> right[get]", 278);
            return 278
        }
    },
    bottom: {
        get() {
            v_console_log("  [*] DOMRectReadOnly -> bottom[get]", 22.75);
            return 22.75
        }
    },
    width: {
        get() {
            v_console_log("  [*] DOMRectReadOnly -> width[get]", 278);
            return 278
        }
    },
    height: {
        get() {
            v_console_log("  [*] DOMRectReadOnly -> height[get]", 22.75);
            return 22.75
        }
    },
    x: {
        get() {
            v_console_log("  [*] DOMRectReadOnly -> x[get]", 0);
            return 0
        }
    },
    y: {
        get() {
            v_console_log("  [*] DOMRectReadOnly -> y[get]", 0);
            return 0
        }
    },
    toJSON: {
        value: v_saf(function toJSON() {
            v_console_log("  [*] DOMRectReadOnly -> toJSON[func]", [].slice.call(arguments));
        })
    },
...
Object.defineProperties(PluginArray.prototype, {
    ...
    item: {
        value: v_saf(function item() {
            v_console_log("  [*] PluginArray -> item[func]", [].slice.call(arguments));
        })
    },
...
Object.defineProperties(CanvasRenderingContext2D.prototype, {
    ...
    filter: {
        set() {
            v_console_log("  [*] CanvasRenderingContext2D -> filter[set]", [].slice.call(arguments));
        }
    },
    createRadialGradient: {
        value: v_saf(function createRadialGradient() {
            v_console_log("  [*] CanvasRenderingContext2D -> createRadialGradient[func]", [].slice.call(arguments));
        })
    },
    shadowColor: {
        set() {
            v_console_log("  [*] CanvasRenderingContext2D -> shadowColor[set]", [].slice.call(arguments));
        }
    },
    shadowBlur: {
        set() {
    ...
    shadowOffsetX: {
        set() {
            v_console_log("  [*] CanvasRenderingContext2D -> shadowOffsetX[set]", [].slice.call(arguments));
        }
    },
    shadowOffsetY: {
        set() {
            v_console_log("  [*] CanvasRenderingContext2D -> shadowOffsetY[set]", [].slice.call(arguments));
        }
    },
    strokeStyle: {
        set() {
            v_console_log("  [*] CanvasRenderingContext2D -> strokeStyle[set]", [].slice.call(arguments));
        }
    },
    lineWidth: {
        set() {
    ...
    moveTo: {
        value: v_saf(function moveTo() {
            v_console_log("  [*] CanvasRenderingContext2D -> moveTo[func]", [].slice.call(arguments));
        })
    },
    lineTo: {
        value: v_saf(function lineTo() {
            v_console_log("  [*] CanvasRenderingContext2D -> lineTo[func]", [].slice.call(arguments));
        })
    },
    stroke: {
...
Object.defineProperties(ReadableStream.prototype, {
    getReader: {
        value: v_saf(function getReader() {
            v_console_log("  [*] ReadableStream -> getReader[func]", [].slice.call(arguments));
        })
    },
...
Object.defineProperties(ReadableStreamDefaultReader.prototype, {
    read: {
        value: v_saf(function read() {
            v_console_log("  [*] ReadableStreamDefaultReader -> read[func]", [].slice.call(arguments));
        })
    },
    closed: {
        get() {
            v_console_log("  [*] ReadableStreamDefaultReader -> closed[get]", {});
            return {}
        }
    },
    [Symbol.toStringTag]: {
...
Object.defineProperties(ReadableStreamDefaultController.prototype, {
    enqueue: {
        value: v_saf(function enqueue() {
            v_console_log("  [*] ReadableStreamDefaultController -> enqueue[func]", [].slice.call(arguments));
        })
    },
    close: {
        value: v_saf(function close() {
            v_console_log("  [*] ReadableStreamDefaultController -> close[func]", [].slice.call(arguments));
        })
    },
    [Symbol.toStringTag]: {
...
Object.defineProperties(FinalizationRegistry.prototype, {
    register: {
        value: v_saf(function register() {
            v_console_log("  [*] FinalizationRegistry -> register[func]", [].slice.call(arguments));
        })
    },
    unregister: {
        value: v_saf(function unregister() {
            v_console_log("  [*] FinalizationRegistry -> unregister[func]", [].slice.call(arguments));
        })
    },
    [Symbol.toStringTag]: {value: "FinalizationRegistry", writable: false, enumerable: false, configurable: true},
})
...
Object.defineProperties(EventCounts.prototype, {
    size: {
        get() {
            v_console_log("  [*] EventCounts -> size[get]", 36);
            return 36
        }
    },
...
Object.defineProperties(Scheduler.prototype, {
    postTask: {
        value: v_saf(function postTask() {
            v_console_log("  [*] Scheduler -> postTask[func]", [].slice.call(arguments));
        })
    },
...
Object.defineProperties(LayoutShiftAttribution.prototype, {
    node: {
        get() {
            v_console_log("  [*] LayoutShiftAttribution -> node[get]", {});
            return {}
        }
    },
    previousRect: {
        get() {
            v_console_log("  [*] LayoutShiftAttribution -> previousRect[get]", {});
            return {}
        }
    },
    currentRect: {
        get() {
            v_console_log("  [*] LayoutShiftAttribution -> currentRect[get]", {});
            return {}
        }
    },
...
Object.defineProperties(PerformanceTiming.prototype, {
    loadEventEnd: {
        get() {
            v_console_log("  [*] PerformanceTiming -> loadEventEnd[get]", 1754483749442);
            return 1754483749442
        }
    },
    navigationStart: {
        get() {
            v_console_log("  [*] PerformanceTiming -> navigationStart[get]", 1754483746864);
            return 1754483746864
        }
    },
...
Object.defineProperties(ResizeObserverEntry.prototype, {
    ...
    borderBoxSize: {
        get() {
            v_console_log("  [*] ResizeObserverEntry -> borderBoxSize[get]", {});
            return {}
        }
    },
...
Object.defineProperties(VideoFrame.prototype, {
    close: {
        value: v_saf(function close() {
            v_console_log("  [*] VideoFrame -> close[func]", [].slice.call(arguments));
        })
    },
    [Symbol.toStringTag]: {value: "VideoFrame", writable: false, enumerable: false, configurable: true},
})
...
Object.defineProperties(IDBFactory.prototype, {
    open: {
        value: v_saf(function open() {
            v_console_log("  [*] IDBFactory -> open[func]", [].slice.call(arguments));
        })
    },
...
Object.defineProperties(ResizeObserverSize.prototype, {
    inlineSize: {
        get() {
            v_console_log("  [*] ResizeObserverSize -> inlineSize[get]", 300);
            return 300
        }
    },
    blockSize: {
        get() {
            v_console_log("  [*] ResizeObserverSize -> blockSize[get]", 34.203125);
            return 34.203125
        }
    },
...
Object.defineProperties(CanvasGradient.prototype, {
    addColorStop: {
        value: v_saf(function addColorStop() {
            v_console_log("  [*] CanvasGradient -> addColorStop[func]", [].slice.call(arguments));
        })
    },
    [Symbol.toStringTag]: {value: "CanvasGradient", writable: false, enumerable: false, configurable: true},
})
Object.defineProperties(SVGRect.prototype, {
    x: {
        get() {
            v_console_log("  [*] SVGRect -> x[get]", 10.5);
            return 10.5
        }
    },
    y: {
        get() {
            v_console_log("  [*] SVGRect -> y[get]", 20.25);
            return 20.25
        }
    },
    width: {
        get() {
            v_console_log("  [*] SVGRect -> width[get]", 123.44999694824219);
            return 123.44999694824219
        }
    },
    height: {
        get() {
            v_console_log("  [*] SVGRect -> height[get]", 67.88999938964844);
            return 67.88999938964844
        }
    },
...
Object.defineProperties(Performance.prototype, {
    ...
    eventCounts: {
        get() {
            v_console_log("  [*] Performance -> eventCounts[get]", {});
            return {}
        }
    },
    getEntries: {
        value: v_saf(function getEntries() {
            v_console_log("  [*] Performance -> getEntries[func]", [].slice.call(arguments));
        })
    },
    timing: {
        get() {
...
Object.defineProperties(Node.prototype, {
    ...
    baseURI: {
        get() {
            v_console_log("  [*] Node -> baseURI[get]", "https://live.douyin.com/61306980056?activity_name=&anchor_id=67025947737&banner_type=recommend&category_name=all&page_type=live_main_page");
            return "https://live.douyin.com/61306980056?activity_name=&anchor_id=67025947737&banner_type=recommend&category_name=all&page_type=live_main_page"
        }
    },
    parentElement: {
        get() {
    ...
    textContent: {
        get() {
            v_console_log("  [*] Node -> textContent[get]", "[{\"name\":\"middleware_perf_timing_start\",\"startTime\":0,\"endTime\":0,\"duration\":0,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":false}},{\"name\":\"middleware_stable_before\",\"startTime\":0.16,\"endTime\":0.17,\"duration\":0.01,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"middleware_handle_before\",\"startTime\":0.17,\"endTime\":0.47,\"duration\":0.3,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"middleware_reflow_before\",\"startTime\":0.48,\"endTime\":0.65,\"duration\":0.17,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"middleware_iframe_before\",\"startTime\":0.66,\"endTime\":0.66,\"duration\":0,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"middleware_ttwid_before\",\"startTime\":0.67,\"endTime\":29.娱乐指数-电视剧排名,\"duration\":28.58,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"middleware_csp_before\",\"startTime\":29.27,\"endTime\":32,\"duration\":2.73,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"middleware_extractor_before\",\"startTime\":32.01,\"endTime\":32.01,\"duration\":0,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"middleware_location_before\",\"startTime\":32.17,\"endTime\":80.43,\"duration\":48.26,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"middleware_odin_before\",\"startTime\":82.86,\"endTime\":113.79,\"duration\":30.93,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"middleware_common_before\",\"startTime\":113.8,\"endTime\":156.7,\"duration\":42.9,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"middleware_redirect_before\",\"startTime\":169.18,\"endTime\":169.18,\"duration\":0,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":false}},{\"name\":\"app_render\",\"startTime\":413.59,\"endTime\":418.41,\"duration\":4.82,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"AppInitData\",\"startTime\":170.01,\"endTime\":413.57,\"duration\":243.56,\"entryType\":\"fetcher\",\"detail\":{\"markEnd\":true}},{\"name\":\"middleware_render_start\",\"startTime\":173.79,\"endTime\":173.79,\"duration\":0,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":false}},{\"name\":\"middleware_prerender_start\",\"startTime\":173.79,\"endTime\":173.79,\"duration\":0,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":false}},{\"name\":\"middleware_shell_ready_at\",\"startTime\":178.49,\"endTime\":178.49,\"duration\":0,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":false}},{\"name\":\"DetailDataAPI\",\"startTime\":425.9,\"endTime\":646.3,\"duration\":220.4,\"entryType\":\"fetcher\",\"detail\":{\"markEnd\":true}},{\"name\":\"neo_enter_room_api\",\"startTime\":427.9,\"endTime\":646.15,\"duration\":218.娱乐指数-电视剧排名,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"RegisterTimeAPI\",\"startTime\":428.02,\"endTime\":515.72,\"duration\":87.7,\"entryType\":\"fetcher\",\"detail\":{\"markEnd\":true}},{\"name\":\"layout\",\"startTime\":462.79,\"endTime\":462.79,\"duration\":0,\"entryType\":\"component\",\"detail\":{\"markEnd\":false}},{\"name\":\"dy_navigation\",\"startTime\":470.16,\"endTime\":470.16,\"duration\":0,\"entryType\":\"component\",\"detail\":{\"markEnd\":false}},{\"name\":\"horizontal_tab\",\"startTime\":471.63,\"endTime\":471.63,\"duration\":0,\"entryType\":\"component\",\"detail\":{\"markEnd\":false}},{\"name\":\"middleware_all_ready_at\",\"startTime\":673.盼之代售-信息采集,\"endTime\":673.盼之代售-信息采集,\"duration\":0,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":false}},{\"name\":\"middleware_shell_ready_duration\",\"startTime\":4.7,\"endTime\":4.7,\"duration\":4.7,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":false}},{\"name\":\"middleware_all_ready_duration\",\"startTime\":499.44,\"endTime\":499.44,\"duration\":499.44,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":false}}]");
            return "[{\"name\":\"middleware_perf_timing_start\",\"startTime\":0,\"endTime\":0,\"duration\":0,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":false}},{\"name\":\"middleware_stable_before\",\"startTime\":0.16,\"endTime\":0.17,\"duration\":0.01,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"middleware_handle_before\",\"startTime\":0.17,\"endTime\":0.47,\"duration\":0.3,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"middleware_reflow_before\",\"startTime\":0.48,\"endTime\":0.65,\"duration\":0.17,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"middleware_iframe_before\",\"startTime\":0.66,\"endTime\":0.66,\"duration\":0,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"middleware_ttwid_before\",\"startTime\":0.67,\"endTime\":29.娱乐指数-电视剧排名,\"duration\":28.58,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"middleware_csp_before\",\"startTime\":29.27,\"endTime\":32,\"duration\":2.73,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"middleware_extractor_before\",\"startTime\":32.01,\"endTime\":32.01,\"duration\":0,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"middleware_location_before\",\"startTime\":32.17,\"endTime\":80.43,\"duration\":48.26,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"middleware_odin_before\",\"startTime\":82.86,\"endTime\":113.79,\"duration\":30.93,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"middleware_common_before\",\"startTime\":113.8,\"endTime\":156.7,\"duration\":42.9,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"middleware_redirect_before\",\"startTime\":169.18,\"endTime\":169.18,\"duration\":0,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":false}},{\"name\":\"app_render\",\"startTime\":413.59,\"endTime\":418.41,\"duration\":4.82,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"AppInitData\",\"startTime\":170.01,\"endTime\":413.57,\"duration\":243.56,\"entryType\":\"fetcher\",\"detail\":{\"markEnd\":true}},{\"name\":\"middleware_render_start\",\"startTime\":173.79,\"endTime\":173.79,\"duration\":0,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":false}},{\"name\":\"middleware_prerender_start\",\"startTime\":173.79,\"endTime\":173.79,\"duration\":0,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":false}},{\"name\":\"middleware_shell_ready_at\",\"startTime\":178.49,\"endTime\":178.49,\"duration\":0,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":false}},{\"name\":\"DetailDataAPI\",\"startTime\":425.9,\"endTime\":646.3,\"duration\":220.4,\"entryType\":\"fetcher\",\"detail\":{\"markEnd\":true}},{\"name\":\"neo_enter_room_api\",\"startTime\":427.9,\"endTime\":646.15,\"duration\":218.娱乐指数-电视剧排名,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":true}},{\"name\":\"RegisterTimeAPI\",\"startTime\":428.02,\"endTime\":515.72,\"duration\":87.7,\"entryType\":\"fetcher\",\"detail\":{\"markEnd\":true}},{\"name\":\"layout\",\"startTime\":462.79,\"endTime\":462.79,\"duration\":0,\"entryType\":\"component\",\"detail\":{\"markEnd\":false}},{\"name\":\"dy_navigation\",\"startTime\":470.16,\"endTime\":470.16,\"duration\":0,\"entryType\":\"component\",\"detail\":{\"markEnd\":false}},{\"name\":\"horizontal_tab\",\"startTime\":471.63,\"endTime\":471.63,\"duration\":0,\"entryType\":\"component\",\"detail\":{\"markEnd\":false}},{\"name\":\"middleware_all_ready_at\",\"startTime\":673.盼之代售-信息采集,\"endTime\":673.盼之代售-信息采集,\"duration\":0,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":false}},{\"name\":\"middleware_shell_ready_duration\",\"startTime\":4.7,\"endTime\":4.7,\"duration\":4.7,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":false}},{\"name\":\"middleware_all_ready_duration\",\"startTime\":499.44,\"endTime\":499.44,\"duration\":499.44,\"entryType\":\"middleware\",\"detail\":{\"markEnd\":false}}]"
        }, set() {
    ...
    getRootNode: {
        value: v_saf(function getRootNode() {
            v_console_log("  [*] Node -> getRootNode[func]", [].slice.call(arguments));
        })
    },
    isEqualNode: {
    ...
    isConnected: {
        get() {
            v_console_log("  [*] Node -> isConnected[get]", true);
            return true
        }
    },
...
Object.defineProperties(MessagePort.prototype, {
    ...
    start: {
        value: v_saf(function start() {
            v_console_log("  [*] MessagePort -> start[func]", [].slice.call(arguments));
        })
    },
...
Object.defineProperties(Worker.prototype, {
    onmessage: {
        set() {
            v_console_log("  [*] Worker -> onmessage[set]", [].slice.call(arguments));
        }
    },
    onerror: {
        set() {
            v_console_log("  [*] Worker -> onerror[set]", [].slice.call(arguments));
        }
    },
    postMessage: {
        value: v_saf(function postMessage() {
            v_console_log("  [*] Worker -> postMessage[func]", [].slice.call(arguments));
        })
    },
...
Object.defineProperties(BaseAudioContext.prototype, {
    ...
    createBufferSource: {
        value: v_saf(function createBufferSource() {
            v_console_log("  [*] BaseAudioContext -> createBufferSource[func]", [].slice.call(arguments));
        })
    },
    destination: {
        get() {
...
Object.defineProperties(MediaStream.prototype, {
    getVideoTracks: {
        value: v_saf(function getVideoTracks() {
            v_console_log("  [*] MediaStream -> getVideoTracks[func]", [].slice.call(arguments));
        })
    },
    addTrack: {
        value: v_saf(function addTrack() {
            v_console_log("  [*] MediaStream -> addTrack[func]", [].slice.call(arguments));
        })
    },
    getAudioTracks: {
        value: v_saf(function getAudioTracks() {
            v_console_log("  [*] MediaStream -> getAudioTracks[func]", [].slice.call(arguments));
        })
    },
    [Symbol.toStringTag]: {value: "MediaStream", writable: false, enumerable: false, configurable: true},
})
Object.defineProperties(MediaStreamTrack.prototype, {
    enabled: {
        set() {
            v_console_log("  [*] MediaStreamTrack -> enabled[set]", [].slice.call(arguments));
        }
    },
    [Symbol.toStringTag]: {value: "MediaStreamTrack", writable: false, enumerable: false, configurable: true},
})
...
Object.defineProperties(AudioNode.prototype, {
    ...
    channelCountMode: {
        get() {
            v_console_log("  [*] AudioNode -> channelCountMode[get]", "max");
            return "max"
        }
    },
    channelInterpretation: {
        get() {
            v_console_log("  [*] AudioNode -> channelInterpretation[get]", "speakers");
            return "speakers"
        }
    },
    numberOfInputs: {
        get() {
            v_console_log("  [*] AudioNode -> numberOfInputs[get]", 1);
            return 1
        }
    },
    numberOfOutputs: {
        get() {
            v_console_log("  [*] AudioNode -> numberOfOutputs[get]", 1);
            return 1
        }
    },
    disconnect: {
...
Object.defineProperties(MessageEvent.prototype, {
    data: {
        get() {
            v_console_log("  [*] MessageEvent -> data[get]", "ACK_1_ACK_0_0.015026809563052135");
            return "ACK_1_ACK_0_0.015026809563052135"
        }
    },
    origin: {
        get() {
            v_console_log("  [*] MessageEvent -> origin[get]", "https://lf-zt.douyin.com");
            return "https://lf-zt.douyin.com"
        }
    },
    source: {
        get() {
...
Object.defineProperties(webkitMediaStream.prototype, {
    getVideoTracks: {
        value: v_saf(function getVideoTracks() {
            v_console_log("  [*] webkitMediaStream -> getVideoTracks[func]", [].slice.call(arguments));
        })
    },
    addTrack: {
        value: v_saf(function addTrack() {
            v_console_log("  [*] webkitMediaStream -> addTrack[func]", [].slice.call(arguments));
        })
    },
    getAudioTracks: {
        value: v_saf(function getAudioTracks() {
            v_console_log("  [*] webkitMediaStream -> getAudioTracks[func]", [].slice.call(arguments));
        })
    },
    [Symbol.toStringTag]: {value: "webkitMediaStream", writable: false, enumerable: false, configurable: true},
})
Object.defineProperties(DOMRect.prototype, {
    width: {
        get() {
            v_console_log("  [*] DOMRect -> width[get]", 135.27838134765625);
            return 135.27838134765625
        }
    },
    height: {
        get() {
            v_console_log("  [*] DOMRect -> height[get]", 135.27838134765625);
            return 135.27838134765625
        }
    },
    x: {
        get() {
            v_console_log("  [*] DOMRect -> x[get]", -147.341796875);
            return -147.341796875
        }
    },
    y: {
        get() {
            v_console_log("  [*] DOMRect -> y[get]", -175.123046875);
            return -175.123046875
        }
    },
...
Object.defineProperties(BatteryManager.prototype, {
    ...
    chargingTime: {
        get() {
            v_console_log("  [*] BatteryManager -> chargingTime[get]", null);
            return null
        }
    },
    dischargingTime: {
    ...
    level: {
        get() {
            v_console_log("  [*] BatteryManager -> level[get]", 0.98);
            return 0.98
        }
    },
...
Object.defineProperties(ScreenOrientation.prototype, {
    type: {
        get() {
            v_console_log("  [*] ScreenOrientation -> type[get]", "landscape-primary");
            return "landscape-primary"
        }
    },
    angle: {
        get() {
            v_console_log("  [*] ScreenOrientation -> angle[get]", 0);
            return 0
        }
    },
...
Object.defineProperties(PerformanceResourceTiming.prototype, {
    encodedBodySize: {
        get() {
            v_console_log("  [*] PerformanceResourceTiming -> encodedBodySize[get]", 311289);
            return 311289
        }
    },
    responseEnd: {
        get() {
            v_console_log("  [*] PerformanceResourceTiming -> responseEnd[get]", 1851.8999999985099);
            return 1851.8999999985099
        }
    },
    transferSize: {
        get() {
    ...
    fetchStart: {
        get() {
            v_console_log("  [*] PerformanceResourceTiming -> fetchStart[get]", 17.199999999254942);
            return 17.199999999254942
        }
    },
    redirectStart: {
        get() {
    ...
    domainLookupStart: {
        get() {
            v_console_log("  [*] PerformanceResourceTiming -> domainLookupStart[get]", 17.199999999254942);
            return 17.199999999254942
        }
    },
    domainLookupEnd: {
        get() {
            v_console_log("  [*] PerformanceResourceTiming -> domainLookupEnd[get]", 17.199999999254942);
            return 17.199999999254942
        }
    },
    requestStart: {
        get() {
            v_console_log("  [*] PerformanceResourceTiming -> requestStart[get]", 17.199999999254942);
            return 17.199999999254942
        }
    },
    workerStart: {
        get() {
            v_console_log("  [*] PerformanceResourceTiming -> workerStart[get]", 17);
            return 17
        }
    },
    responseStart: {
        get() {
            v_console_log("  [*] PerformanceResourceTiming -> responseStart[get]", 26.199999999254942);
            return 26.199999999254942
        }
    },
    initiatorType: {
        get() {
            v_console_log("  [*] PerformanceResourceTiming -> initiatorType[get]", "link");
            return "link"
        }
    },
...
Object.defineProperties(PerformanceMark.prototype, {
    detail: {
        get() {
            v_console_log("  [*] PerformanceMark -> detail[get]", {});
            return {}
        }
    },
...
Object.defineProperties(PerformanceMeasure.prototype, {
    detail: {
        get() {
            v_console_log("  [*] PerformanceMeasure -> detail[get]", {});
            return {}
        }
    },
...
Object.defineProperties(WebSocket.prototype, {
    binaryType: {
        set() {
            v_console_log("  [*] WebSocket -> binaryType[set]", [].slice.call(arguments));
        }
    },
    readyState: {
        get() {
            v_console_log("  [*] WebSocket -> readyState[get]", 1);
            return 1
        }
    },
    send: {
        value: v_saf(function send() {
            v_console_log("  [*] WebSocket -> send[func]", [].slice.call(arguments));
        })
    },
...
Object.defineProperties(LayoutShift.prototype, {
    ...
    value: {
        get() {
            v_console_log("  [*] LayoutShift -> value[get]", 0.00046726667384834977);
            return 0.00046726667384834977
        }
    },
    sources: {
        get() {
            v_console_log("  [*] LayoutShift -> sources[get]", {});
            return {}
        }
    },
...
Object.defineProperties(IDBRequest.prototype, {
    onerror: {
        set() {
            v_console_log("  [*] IDBRequest -> onerror[set]", [].slice.call(arguments));
        }
    },
    onsuccess: {
        set() {
            v_console_log("  [*] IDBRequest -> onsuccess[set]", [].slice.call(arguments));
        }
    },
    result: {
        get() {
            v_console_log("  [*] IDBRequest -> result[get]", {});
            return {}
        }
    },
...
Object.defineProperties(PerformanceLongTaskTiming.prototype, {
    toJSON: {
        value: v_saf(function toJSON() {
            v_console_log("  [*] PerformanceLongTaskTiming -> toJSON[func]", [].slice.call(arguments));
        })
    },
...
Object.defineProperties(TaskAttributionTiming.prototype, {
    toJSON: {
        value: v_saf(function toJSON() {
            v_console_log("  [*] TaskAttributionTiming -> toJSON[func]", [].slice.call(arguments));
        })
    },
...
Object.defineProperties(Document.prototype, {
    ...
    referrer: {
        get() {
            v_console_log("  [*] Document -> referrer[get]", "https://live.douyin.com/61306980056?activity_name=&anchor_id=67025947737&banner_type=recommend&category_name=all&page_type=live_main_page");
            return "https://live.douyin.com/61306980056?activity_name=&anchor_id=67025947737&banner_type=recommend&category_name=all&page_type=live_main_page"
        }
    },
    hidden: {
    ...
    fonts: {
        get() {
            v_console_log("  [*] Document -> fonts[get]", {});
            return {}
        }
    },
    title: {
        get() {
            v_console_log("  [*] Document -> title[get]", "抖音直播电脑版_抖音直播网页版入口_抖音直播");
            return "抖音直播电脑版_抖音直播网页版入口_抖音直播"
        }, set() {
    ...
    domain: {
        get() {
            v_console_log("  [*] Document -> domain[get]", "live.douyin.com");
            return "live.douyin.com"
        }
    },
    wasDiscarded: {
    ...
    hasFocus: {
        value: v_saf(function hasFocus() {
            v_console_log("  [*] Document -> hasFocus[func]", [].slice.call(arguments));
        })
    },
    onreadystatechange: {
        get() {
...
Object.defineProperties(CharacterData.prototype, {
    data: {
        get() {
            ...
            v_console_log("  [*] CharacterData -> data[set]", [].slice.call(arguments));
            return "/$"
        }
    },
...
Object.defineProperties(Element.prototype, {
    ...
    replaceWith: {
        value: v_saf(function replaceWith() {
            v_console_log("  [*] Element -> replaceWith[func]", [].slice.call(arguments));
        })
    },
    classList: {
        get() {
    ...
    innerHTML: {
        get() {
            v_console_log("  [*] Element -> innerHTML[get]", "<div class=\"webcast-chatroom U2qEGdDQ\"><div class=\"pZzS8QUV\"><div class=\"Y3jYZAlL\"></div></div><div class=\"webcast-chatroom___input-container\" id=\"chatInput\" style=\"height: fit-content;\"><div class=\"webcast-chatroom___emoji-icon\"><svg width=\"36\" height=\"36\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\"><path fill-rule=\"evenodd\" clip-rule=\"evenodd\" d=\"M27 18a9 9 0 1 1-18 0 9 9 0 0 1 18 0zm-9 11c6.075 0 11-4.925 11-11S24.075 7 18 7 7 11.925 7 18s4.925 11 11 11zm-2-13.5c0 1.105-.672 2-1.5 2s-1.5-.895-1.5-2 .672-2 1.5-2 1.5.895 1.5 2zm5.5 2c.828 0 1.5-.895 1.5-2s-.672-2-1.5-2-1.5.895-1.5 2 .672 2 1.5 2zM18 兰州交大招标信息.03c-1.657 0-3-.96-3-2.143 0-1.183 6-1.183 6 0 0 1.184-1.343 2.143-3 2.143z\" fill=\"#fff\" fill-opacity=\".5\"></path></svg></div><div class=\"_qiHqqRE jpTr0_9f\" data-e2e=\"live-chatting\"></div><svg width=\"36\" height=\"36\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\" type=\"button\" class=\"webcast-chatroom___send-btn btn-icon\"><path fill-rule=\"evenodd\" clip-rule=\"evenodd\" d=\"M17.5 30C23.851 30 29 云南建筑监管公共服务平台.851 29 18.5S23.851 7 17.5 7 6 12.149 6 18.5 11.149 30 17.5 30zm-5.16-13.883a1.16 1.16 0 0 0 1.64 1.64l2.395-2.394v8.838a1.16 1.16 0 0 0 2.321 0v-8.839l1.028 1.028 1.368 1.368a1.16 1.16 0 1 0 1.64-1.641l-4.219-4.22a1.382 1.382 0 0 0-1.954 0l-4.兰州交大招标信息 4.22h.001z\" fill=\"#FE2C55\"></path><path d=\"M12.34 16.117a1.16 1.16 0 0 0 1.64 1.64l2.395-2.394v8.838a1.16 1.16 0 0 0 2.321 0v-8.839l1.028 1.028 1.368 1.368a1.16 1.16 0 1 0 1.64-1.641l-4.219-4.22a1.382 1.382 0 0 0-1.954 0l-4.兰州交大招标信息 4.22h.001z\" fill=\"#fff\"></path></svg></div></div>");
            return "<div class=\"webcast-chatroom U2qEGdDQ\"><div class=\"pZzS8QUV\"><div class=\"Y3jYZAlL\"></div></div><div class=\"webcast-chatroom___input-container\" id=\"chatInput\" style=\"height: fit-content;\"><div class=\"webcast-chatroom___emoji-icon\"><svg width=\"36\" height=\"36\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\"><path fill-rule=\"evenodd\" clip-rule=\"evenodd\" d=\"M27 18a9 9 0 1 1-18 0 9 9 0 0 1 18 0zm-9 11c6.075 0 11-4.925 11-11S24.075 7 18 7 7 11.925 7 18s4.925 11 11 11zm-2-13.5c0 1.105-.672 2-1.5 2s-1.5-.895-1.5-2 .672-2 1.5-2 1.5.895 1.5 2zm5.5 2c.828 0 1.5-.895 1.5-2s-.672-2-1.5-2-1.5.895-1.5 2 .672 2 1.5 2zM18 兰州交大招标信息.03c-1.657 0-3-.96-3-2.143 0-1.183 6-1.183 6 0 0 1.184-1.343 2.143-3 2.143z\" fill=\"#fff\" fill-opacity=\".5\"></path></svg></div><div class=\"_qiHqqRE jpTr0_9f\" data-e2e=\"live-chatting\"></div><svg width=\"36\" height=\"36\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\" type=\"button\" class=\"webcast-chatroom___send-btn btn-icon\"><path fill-rule=\"evenodd\" clip-rule=\"evenodd\" d=\"M17.5 30C23.851 30 29 云南建筑监管公共服务平台.851 29 18.5S23.851 7 17.5 7 6 12.149 6 18.5 11.149 30 17.5 30zm-5.16-13.883a1.16 1.16 0 0 0 1.64 1.64l2.395-2.394v8.838a1.16 1.16 0 0 0 2.321 0v-8.839l1.028 1.028 1.368 1.368a1.16 1.16 0 1 0 1.64-1.641l-4.219-4.22a1.382 1.382 0 0 0-1.954 0l-4.兰州交大招标信息 4.22h.001z\" fill=\"#FE2C55\"></path><path d=\"M12.34 16.117a1.16 1.16 0 0 0 1.64 1.64l2.395-2.394v8.838a1.16 1.16 0 0 0 2.321 0v-8.839l1.028 1.028 1.368 1.368a1.16 1.16 0 1 0 1.64-1.641l-4.219-4.22a1.382 1.382 0 0 0-1.954 0l-4.兰州交大招标信息 4.22h.001z\" fill=\"#fff\"></path></svg></div></div>"
        }, set() {
    ...
    childElementCount: {
        get() {
            v_console_log("  [*] Element -> childElementCount[get]", 7);
            return 7
        }
    },
    prepend: {
        value: v_saf(function prepend() {
            v_console_log("  [*] Element -> prepend[func]", [].slice.call(arguments));
        })
    },
    append: {
        value: v_saf(function append() {
            v_console_log("  [*] Element -> append[func]", [].slice.call(arguments));
        })
    },
    clientWidth: {
        get() {
    ...
    clientHeight: {
        get() {
            v_console_log("  [*] Element -> clientHeight[get]", 144);
            return 144
        }
    },
    children: {
    ...
    before: {
        value: v_saf(function before() {
            v_console_log("  [*] Element -> before[func]", [].slice.call(arguments));
        })
    },
    ...
    className: {
        get() {
            v_console_log("  [*] Element -> className[get]", "ace-line");
            return "ace-line"
        }, set() {
    ...
    scrollTo: {
        value: v_saf(function scrollTo() {
            v_console_log("  [*] Element -> scrollTo[func]", [].slice.call(arguments));
        })
    },
    scrollHeight: {
        get() {
            v_console_log("  [*] Element -> scrollHeight[get]", 631);
            return 631
        }
    },
...
Object.defineProperties(AudioContext.prototype, {
    suspend: {
        value: v_saf(function suspend() {
            v_console_log("  [*] AudioContext -> suspend[func]", [].slice.call(arguments));
        })
    },
    close: {
        value: v_saf(function close() {
    ...
    createMediaStreamDestination: {
        value: v_saf(function createMediaStreamDestination() {
            v_console_log("  [*] AudioContext -> createMediaStreamDestination[func]", [].slice.call(arguments));
        })
    },
    resume: {
        value: v_saf(function resume() {
            v_console_log("  [*] AudioContext -> resume[func]", [].slice.call(arguments));
        })
    },
...
Object.defineProperties(MediaStreamTrackGenerator.prototype, {
    writable: {
        get() {
            v_console_log("  [*] MediaStreamTrackGenerator -> writable[get]", {});
            return {}
        }
    },
    [Symbol.toStringTag]: {value: "MediaStreamTrackGenerator", writable: false, enumerable: false, configurable: true},
})
...
Object.defineProperties(MediaStreamAudioDestinationNode.prototype, {
    stream: {
        get() {
            v_console_log("  [*] MediaStreamAudioDestinationNode -> stream[get]", {});
            return {}
        }
    },
    [Symbol.toStringTag]: {
...
Object.defineProperties(AudioWorkletNode.prototype, {
    ...
    [Symbol.toStringTag]: {value: "AudioWorkletNode", writable: false, enumerable: false, configurable: true},
})
Object.defineProperties(DocumentFragment.prototype, {
    firstElementChild: {
        get() {
            v_console_log("  [*] DocumentFragment -> firstElementChild[get]", {});
            return {}
        }
    },
...
Object.defineProperties(AudioDestinationNode.prototype, {
    maxChannelCount: {
        get() {
            v_console_log("  [*] AudioDestinationNode -> maxChannelCount[get]", 2);
            return 2
        }
    },
    [Symbol.toStringTag]: {value: "AudioDestinationNode", writable: false, enumerable: false, configurable: true},
})
Object.defineProperties(AnalyserNode.prototype, {
    fftSize: {
        get() {
            v_console_log("  [*] AnalyserNode -> fftSize[get]", 2048);
            return 2048
        }
    },
    frequencyBinCount: {
        get() {
            v_console_log("  [*] AnalyserNode -> frequencyBinCount[get]", 1024);
            return 1024
        }
    },
    maxDecibels: {
        get() {
            v_console_log("  [*] AnalyserNode -> maxDecibels[get]", -30);
            return -30
        }
    },
    minDecibels: {
        get() {
            v_console_log("  [*] AnalyserNode -> minDecibels[get]", -100);
            return -100
        }
    },
    smoothingTimeConstant: {
        get() {
            v_console_log("  [*] AnalyserNode -> smoothingTimeConstant[get]", 0.8);
            return 0.8
        }
    },
    getFloatFrequencyData: {
        value: v_saf(function getFloatFrequencyData() {
            v_console_log("  [*] AnalyserNode -> getFloatFrequencyData[func]", [].slice.call(arguments));
        })
    },
    getFloatTimeDomainData: {
        value: v_saf(function getFloatTimeDomainData() {
            v_console_log("  [*] AnalyserNode -> getFloatTimeDomainData[func]", [].slice.call(arguments));
        })
    },
    [Symbol.toStringTag]: {value: "AnalyserNode", writable: false, enumerable: false, configurable: true},
})
...
Object.defineProperties(PerformanceNavigationTiming.prototype, {
    type: {
        get() {
            v_console_log("  [*] PerformanceNavigationTiming -> type[get]", "navigate");
            return "navigate"
        }
    },
    domContentLoadedEventEnd: {
        get() {
            v_console_log("  [*] PerformanceNavigationTiming -> domContentLoadedEventEnd[get]", 2087.89999999851);
            return 2087.89999999851
        }
    },
    domContentLoadedEventStart: {
        get() {
            v_console_log("  [*] PerformanceNavigationTiming -> domContentLoadedEventStart[get]", 2086.199999999255);
            return 2086.199999999255
        }
    },
    domInteractive: {
        get() {
            v_console_log("  [*] PerformanceNavigationTiming -> domInteractive[get]", 2033.7999999970198);
            return 2033.7999999970198
        }
    },
    loadEventStart: {
        get() {
            v_console_log("  [*] PerformanceNavigationTiming -> loadEventStart[get]", 2578.099999997765);
            return 2578.099999997765
        }
    },
    domComplete: {
        get() {
            v_console_log("  [*] PerformanceNavigationTiming -> domComplete[get]", 2555.099999997765);
            return 2555.099999997765
        }
    },
    loadEventEnd: {
        get() {
            v_console_log("  [*] PerformanceNavigationTiming -> loadEventEnd[get]", 2578.199999999255);
            return 2578.199999999255
        }
    },
    [Symbol.toStringTag]: {
...
Object.defineProperties(IDBOpenDBRequest.prototype, {
    onupgradeneeded: {
        set() {
            v_console_log("  [*] IDBOpenDBRequest -> onupgradeneeded[set]", [].slice.call(arguments));
        }
    },
...
Object.defineProperties(HTMLElement.prototype, {
    nonce: {
        get() {
            v_console_log("  [*] HTMLElement -> nonce[get]", "Lmmm_ymDcHLEihapSHjmR");
            return "Lmmm_ymDcHLEihapSHjmR"
        }, set() {
            v_console_log("  [*] HTMLElement -> nonce[set]", [].slice.call(arguments));
            return "Lmmm_ymDcHLEihapSHjmR"
        }
    },
    onload: {
    ...
    tabIndex: {
        set() {
            v_console_log("  [*] HTMLElement -> tabIndex[set]", [].slice.call(arguments));
            return {}
        }
    },
    style: {
    ...
    innerText: {
        get() {
            v_console_log("  [*] HTMLElement -> innerText[get]", "从你的全世界路过：");
            return "从你的全世界路过："
        }, set() {
    ...
    offsetWidth: {
        get() {
            v_console_log("  [*] HTMLElement -> offsetWidth[get]", 660);
            return 660
        }
    },
    blur: {
        value: v_saf(function blur() {
            v_console_log("  [*] HTMLElement -> blur[func]", [].slice.call(arguments));
        })
    },
    onmouseenter: {
        get() {
...
Object.defineProperties(AudioBufferSourceNode.prototype, {
    start: {
        value: v_saf(function start() {
            v_console_log("  [*] AudioBufferSourceNode -> start[func]", [].slice.call(arguments));
        })
    },
    [Symbol.toStringTag]: {value: "AudioBufferSourceNode", writable: false, enumerable: false, configurable: true},
})
...
Object.defineProperties(SVGElement.prototype, {
    onclick: {
        set() {
            v_console_log("  [*] SVGElement -> onclick[set]", [].slice.call(arguments));
        }
    },
    style: {
        get() {
...
Object.defineProperties(HTMLMediaElement.prototype, {
    srcObject: {
        get() {
            v_console_log("  [*] HTMLMediaElement -> srcObject[get]", {});
            return {}
        }, set() {
            v_console_log("  [*] HTMLMediaElement -> srcObject[set]", [].slice.call(arguments));
            return {}
        }
    },
    volume: {
    ...
    muted: {
        get() {
            v_console_log("  [*] HTMLMediaElement -> muted[get]", false);
            return false
        }, set() {
    ...
    currentTime: {
        get() {
            v_console_log("  [*] HTMLMediaElement -> currentTime[get]", 31.737);
            return 31.737
        }
    },
    paused: {
    ...
    loop: {
        get() {
            v_console_log("  [*] HTMLMediaElement -> loop[get]", false);
            return false
        }
    },
    controls: {
        get() {
            v_console_log("  [*] HTMLMediaElement -> controls[get]", false);
            return false
        }
    },
    canPlayType: {
...
Object.defineProperties(HTMLScriptElement.prototype, {
    src: {
        get() {
            v_console_log("  [*] HTMLScriptElement -> src[get]", "");
            return ""
        }, set() {
...
Object.defineProperties(HTMLLinkElement.prototype, {
    rel: {
        get() {
            v_console_log("  [*] HTMLLinkElement -> rel[get]", "preconnect");
            return "preconnect"
        }, set() {
...
Object.defineProperties(HTMLInputElement.prototype, {
    ...
    name: {
        set() {
            v_console_log("  [*] HTMLInputElement -> name[set]", [].slice.call(arguments));
            return ""
        }
    },
...
Object.defineProperties(SVGGraphicsElement.prototype, {
    getBBox: {
        value: v_saf(function getBBox() {
            v_console_log("  [*] SVGGraphicsElement -> getBBox[func]", [].slice.call(arguments));
        })
    },
...
Object.defineProperties(HTMLVideoElement.prototype, {
    videoWidth: {
        get() {
            v_console_log("  [*] HTMLVideoElement -> videoWidth[get]", 480);
            return 480
        }
    },
    videoHeight: {
        get() {
            v_console_log("  [*] HTMLVideoElement -> videoHeight[get]", 854);
            return 854
        }
    },
...
window.event = v_new(CustomEvent)
...
window.scheduler = v_new(Scheduler)
...
init_cookie("__ac_signature=_02B4Z6wo00f017rZmbQAAIDBWRZpIJlUtde6-Z0AAIYt27; __live_version__=%221.1.3.6863%兰州交大招标信息; live_use_vvc=%22false%兰州交大招标信息; xgplayer_user_id=639550798944; fpk1=U2FsdGVkX1+pQB9WPbFkLNaYhxCU1xd/3jy0ROMTuw1gjRfMltto0B62YR9ZR14939ASKlN1jTd09/UUKmuyVg==; fpk2=d2ad6785d256851dd366703bdc61aa61; __security_mc_1_s_sdk_crypt_sdk=5a7d4821-4f8d-863b; bd_ticket_guard_client_web_domain=2; passport_csrf_token=2b94db8891cdd2182148bd5560464229; passport_csrf_token_default=2b94db8891cdd2182148bd5560464229; passport_assist_user=CkokVvbgHm14f7HCOZOdzI2ETxV1OM54taSUUjUxxB-eSEBpTgQIg0deY_SKKjkpOdiX3RdXV2qx5An6Wc6I8Jtf2S6ootP5ZEYu8BpKCjwAAAAAAAAAAAAAT1INefdIqi7GO7sZgo2aEf723sIg0d6tvX5LzNHES0x4YVE5VyJQinrl7v2DJNYx2Q8Q7934DRiJr9ZUIAEiAQMnZu0V; login_time=1754482054929; _bd_ticket_crypt_cookie=28b31bd70a83843f0b55a48f4ecbe748; __security_mc_1_s_sdk_sign_data_key_web_protect=eb960899-4858-9735; __security_mc_1_s_sdk_cert_key=38e1fc41-41e6-9ff1; __security_server_data_status=1; SelfTabRedDotControl=%5B%5D; publish_badge_show_info=%220%2C0%2C0%2C1754482089903%兰州交大招标信息; enter_pc_once=1; UIFID_TEMP=d4579b5b1721ffdd22d8a6ff378781159e3b4e5a1248a83fc8c708ec2606b705a0b1b83f77a0eb89cd164650cd0b8ccb96181adbf4a7ee9090338535af14aa04a751269f5345013e4426df3a97cf6a8d; stream_recommend_feed_params=%兰州交大招标信息%7B%5C%22cookie_enabled%5C%兰州交大招标信息%3Atrue%2C%5C%22screen_width%5C%兰州交大招标信息%3A1920%2C%5C%22screen_height%5C%兰州交大招标信息%3A1080%2C%5C%22browser_online%5C%兰州交大招标信息%3Atrue%2C%5C%22cpu_core_num%5C%兰州交大招标信息%3A8%2C%5C%22device_memory%5C%兰州交大招标信息%3A8%2C%5C%22downlink%5C%兰州交大招标信息%3A10%2C%5C%22effective_type%5C%兰州交大招标信息%3A%5C%224g%5C%兰州交大招标信息%2C%5C%22round_trip_time%5C%兰州交大招标信息%3A50%7D%兰州交大招标信息; home_can_add_dy_2_desktop=%221%兰州交大招标信息; strategyABtestKey=%221754483035.136%兰州交大招标信息; download_guide=%223%2F20250806%2F0%兰州交大招标信息; has_avx2=null; device_web_cpu_core=8; device_web_memory_size=8; webcast_local_quality=null; csrf_session_id=b7513890acc519df37568709fdc13059; passport_fe_beating_status=true; biz_trace_id=b6c77080; sdk_source_info=; bit_env=8sp_-C-PPn4iwodlTI9PlCioMRyYb2Ia_l6-kpiu_EAYnMf1d_n47oxKzjJDTGo2WdQLpLfWHNyZqcrh7pL9OCUIvaxO1lbht3QEoXf3k5iW4ASR3IJx9pHSyOlNgyZcflHQJgW3GsYKoiDDsEC_UTio4Yx_VOcqv3fUTuRVwzcINa8n1FKl6u2dydj3eWBMsDdZ04toEGS8dpHVWtR7t1nkkTVSnn4KINpOSgWdemtJsl9u2khzssxHdEMHJlzDbEJ9Ud3l2xBZg4McojI6ON5aQX6tFAVkZHA-KIMjmxJCKx7QTX_56Zc9S88ASIe5OQ3fWZv0l8pkeAicrBBwBelg8e-FpiJ9GWUMnatW1-NqH4QJBmvYbG9cfqZF6za5AfIKiwyFXYk1FPlmUljPhm7gONlyvtH8QMn_oEYf-UEOmOBavXLGW8cuDWcYW4Fty6uJ_1vzWmXngEy2xAa44Bf7vPpS6mvAB6PkmO5FO2-RWxc8kfMjprUuSR4kj5SSI5IvLZC1QLDDrMjFHNAHXoPPnM42fDn3ppW6IbLdFhg%3D; gulu_source_res=eyJwX2luIjoiNzU0M2ZjOGQ1M2I0ODllM2QzNDA1NDBmYmViY2VhOTQ5YjdkNmE0NmQyY2RiODQzN2RiNDY4OTdiNDkzN2RlZiJ9; live_can_add_dy_2_desktop=%221%兰州交大招标信息; IsDouyinActive=true; bd_ticket_guard_client_data=%3D%3D")
v_hook_href(window.location, 'location', "https://live.douyin.com/61306980056?activity_name=&anchor_id=67025947737&banner_type=recommend&category_name=all&page_type=live_main_page")
...
function v_getele(name, func) {
    if (name == "S:0" && func == "getElementById") {
        return v_new(HTMLDivElement)
    }
    if (name == "B:0" && func == "getElementById") {
        return v_new(HTMLTemplateElement)
    }
    if (name == "S:2" && func == "getElementById") {
        return v_new(HTMLDivElement)
    }
    if (name == "B:2" && func == "getElementById") {
        return v_new(HTMLTemplateElement)
    }
    if (name == ".douyin-player-controls-left" && func == "querySelector") {
        return v_new(HTMLDivElement)
    }
    if (name == ".douyin-player-controls" && func == "querySelector") {
        return v_new(HTMLDivElement)
    }
    if (name == "#script-layouts" && func == "querySelector") {
        return v_new(HTMLDivElement)
    }
    if (name == "#script-set-tea-config" && func == "querySelector") {
        return v_new(HTMLDivElement)
    }
    if (name == "S:1" && func == "getElementById") {
        return v_new(HTMLDivElement)
    }
    if (name == "B:1" && func == "getElementById") {
        return v_new(HTMLTemplateElement)
    }
    ...
    if (name == "island_fa058" && func == "getElementById") {
        return v_new(HTMLElement)
    }
    if (name == "island_da635" && func == "getElementById") {
        return v_new(HTMLElement)
    }
    if (name == "island_a4110" && func == "getElementById") {
        return v_new(HTMLElement)
    }
    if (name == "island_3e027" && func == "getElementById") {
        return v_new(HTMLElement)
    }
    if (name == ".douyin-player-controls-right" && func == "querySelector") {
        return v_new(HTMLDivElement)
    }
    if (name == "#LeftBackgroundLayout" && func == "querySelector") {
        return v_new(HTMLDivElement)
    }
    if (name == "#ContainerBackgroundLayout" && func == "querySelector") {
        return v_new(HTMLDivElement)
    }
    if (name == "[data-id=\"pace-perf-timing\"]" && func == "querySelector") {
        return v_new(HTMLScriptElement)
    }
    if (name == ".douyin-player-volume" && func == "querySelector") {
        return v_new(HTMLDivElement)
    }
    if (name == ".douyin-player-volume-slider" && func == "querySelector") {
        return v_new(HTMLDivElement)
    }
    if (name == "island_076c3" && func == "getElementById") {
        return v_new(HTMLElement)
    }
    if (name == "island_b69f5" && func == "getElementById") {
        return v_new(HTMLElement)
    }
    if (name == "control-right" && func == "getElementById") {
        return v_new(HTMLDivElement)
    }
    if (name == "#TipsLayout" && func == "querySelector") {
        return v_new(HTMLDivElement)
    }
    if (name == "island_237ab" && func == "getElementById") {
        return v_new(HTMLElement)
    }
    if (name == "#_douyin_live_scroll_container_" && func == "querySelector") {
        return v_new(HTMLDivElement)
    }
    if (name == "meta[name=\"theme-color\"]" && func == "querySelector") {
        return v_new(HTMLMetaElement)
    }
    if (name == "btn-feelgood" && func == "getElementById") {
        return v_new(HTMLDivElement)
    }
    if (name == "head" && func == "querySelector") {
        return v_new(HTMLHeadElement)
    }
    if (name == "image_disable" && func == "getElementById") {
        return v_new(HTMLImageElement)
    }
    if (name == "video" && func == "querySelector") {
        return v_new(HTMLVideoElement)
    }
    if (name == "J_uc_iframe_box-1754483767251" && func == "getElementById") {
        return v_new(HTMLDivElement)
    }
    return null
}
...
function v_geteles(name, func) {
    ...
    if (name == "deferred-script" && func == "querySelectorAll") {
        return [v_new(HTMLElement), v_new(HTMLElement), v_new(HTMLElement), v_new(HTMLElement), v_new(HTMLElement), v_new(HTMLElement), v_new(HTMLElement), v_new(HTMLElement), v_new(HTMLElement), v_new(HTMLElement), v_new(HTMLElement), v_new(HTMLElement), v_new(HTMLElement)]
    }
    if (name == "script" && func == "getElementsByTagName") {
        return [v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement), v_new(HTMLScriptElement)]
    }
    if (name == "link" && func == "getElementsByTagName") {
        return [v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement)]
    }
    ...
    if (name == "style" && func == "getElementsByTagName") {
        return [v_new(HTMLStyleElement), v_new(HTMLStyleElement), v_new(HTMLStyleElement), v_new(HTMLStyleElement), v_new(HTMLStyleElement), v_new(HTMLStyleElement)]
    }
    if (name == "link[data-rh]" && func == "querySelectorAll") {
        return [v_new(HTMLLinkElement), v_new(HTMLLinkElement)]
    }
    if (name == "meta[data-rh]" && func == "querySelectorAll") {
        return [v_new(HTMLMetaElement), v_new(HTMLMetaElement), v_new(HTMLMetaElement)]
    }
    if (name == "[rel=preload]" && func == "querySelectorAll") {
        return [v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement), v_new(HTMLLinkElement)]
    }
    if (name == "xgplayer-fullscreen-parent" && func == "getElementsByClassName") {
        return [v_new(HTMLBodyElement)]
    }
    return null
}
    ...
    !function (_0xe67213, _0x19937e) {
        ...
        function _0x4591cd() {
            ...
            function _0x343a1e(_0xc4b124, _0x1026d8, _0x47c875, _0x150a83, _0x4cdf11, _0x3e4a0b, _0x1dd313, _0x2b027d) {
                var _0x1c87ab = w_0x25f3, _0x2f46a5, _0x5a2be0, _0x547138, _0x289168, _0x1e1872, _0xd2fd89,
            ...
            function _0x4c3a0d(_0x48207f, _0x257e35) {
                ...
                for (var _0x47fbbd, _0x402774, _0x333e3a = [], _0xe5fb1e = new Map(), _0x15f194 = new Map(), _0x41a1c1 = -0x1 * 0x575 + -0x13c0 + -0x1b * -0xef; _0x41a1c1 < _0x257e35[_0x1249e7(0x259)]; _0x41a1c1++) {
                    ...
                    if (Array[_0x1249e7(0x2af)](_0x63ddf3)) {
                        var _0x446366, _0x186385, _0x19186f = _0x63ddf3[-0x5bc * 0x4 + 0xf6a * -0x1 + -0x3 * -0xcc9],
        ...
        function _0x23e6b(_0x5cf198, _0x5646db, _0x26f9f9, _0x37f54b, _0x47565f, _0x2aa948, _0xccabc1, _0x5c3a48, _0x9ffbdc) {
            var _0x3e2adf = w_0x25f3, _0x592aeb, _0x365a6e, _0x4e8d10, _0x589008, _0x17d95a, _0x11c9ab,
        ...
        function _0x754898(_0x2bd2c5, _0x2c3dcd, _0x119780) {
            ...
            for (var _0x328f7d, _0x12addf, _0x29a079, _0x3330d8 = [], _0x484293 = new Map(), _0x4a2ea8 = new Map(), _0x478e5d = 0x1 * -0x3e1 + -0x22b8 + 0x2699; _0x478e5d < _0x2c3dcd[_0x42b3ee(0x259)]; _0x478e5d++) {
                ...
                if (Array[_0x42b3ee(0x2af)](_0x5c7927)) {
                    var _0x25ea34, _0x5b9b12, _0x35b641 = _0x5c7927[-0x33b * 0x1 + 0xebe + 0x3 * -0x3d6],
                        _0x49a803 = _0x5c7927[-0x78a + -0x29 * 0x60 + 0xc * 0x1e9],
                        _0x410da0 = _0x5c7927[_0x42b3ee(0x259)] > 0x1291 + -0x1e03 + 0xb75,
                        _0x3c9168 = _0x35b641 >= -0x13e1 * 0x1 + 0x793 + -0x5 * -0x277, _0x41ada5 = _0x119780;
        ...
        function _0x19d66a(_0x14c297, _0x128d38) {
            ...
            if (null != _0x25f943) {
                var _0x285958, _0x5bcc9e, _0x2d4c39, _0x193c70, _0x146015 = [],
        ...
        function _0x246229(_0x5e71a0) {
            ...
            throw new TypeError('\x兰州交大招标信息' + _0x5e71a0 + _0x47c977(0x338));
        }

        function _0x5db7bf(_0x51f915) {
            throw new TypeError('\x兰州交大招标信息' + _0x51f915 + '\x兰州交大招标信息\x20is\x20write-only');
        }

        function _0x2275f4(_0x42246e) {
            var _0x2f7351 = w_0x25f3;
            throw new ReferenceError(_0x2f7351(0x1c7) + _0x42246e + '\x兰州交大招标信息\x20cannot\x20be\x20referenced\x20in\x20computed\x20property\x20keys.');
        }
        ...
        function _0x350075(_0x189dc6, _0x3f6be9) {
            ...
            var _0x23cdd3, _0x5bcfbb = !(0x1 * -0x810 + -0xb3 * 0x2f + 0x1 * 0x28ed),
            ...
            var _0x513b0e = {
                ...
                'toElementDescriptor': function (_0x4c8a60) {
                    ...
                    if (_0x1fc4d7(0x25a) !== _0x33cfb6 && _0x1fc4d7(0x23c) !== _0x33cfb6)
                        throw new TypeError('An\x20element\x20descriptor\x27s\x20.kind\x20property\x20must\x20be\x20either\x20\x22method\x兰州交大招标信息\x20or\x20\x22field\x兰州交大招标信息,\x20but\x20a\x20decorator\x20created\x20an\x20element\x20descriptor\x20with\x20.kind\x20\x兰州交大招标信息' + _0x33cfb6 + '\x兰州交大招标信息');
                    ...
                    if (_0x1fc4d7(0x396) !== _0x52ab63 && _0x1fc4d7(0x344) !== _0x52ab63 && _0x1fc4d7(0x235) !== _0x52ab63)
                        throw new TypeError(_0x1fc4d7(0x2b5) + _0x52ab63 + '\x兰州交大招标信息');
                ...
                'toClassDescriptor': function (_0x178ca0) {
                    ...
                    if ('class' !== _0x79f336)
                        throw new TypeError('A\x20class\x20descriptor\x27s\x20.kind\x20property\x20must\x20be\x20\x22class\x兰州交大招标信息,\x20but\x20a\x20decorator\x20created\x20a\x20class\x20descriptor\x20with\x20.kind\x20\x兰州交大招标信息' + _0x79f336 + '\x兰州交大招标信息');
        ...
        var _0x90795 = _0x56409e(function (_0xb9c7d1) {
            !(function () {
                ...
                var _0x299a21 = !_0x11d177['JS_MD5_NO_COMMON_JS'] && _0xb9c7d1[_0x2db296(0x1b8)],
                    ...
                    _0x146907 = [0x148 * 0x5 + -0x753 * 0x2 + -0x175 * -0x6, 0x1 * 0x340b + 0x460a + 0x1f9 * 0x3, 0x2766cb + -0x6327ac + 0x353 * 0x387b, -(-0xc13e2aae + -0x3aff8440 + 0x17c3daeee)],
                    _0x4d13bd = [-0x1721 + -0x1 * 0x611 + 0x1d32, -0x390 + -0x3a5 * -0x3 + -0x757, 0x5fc + -0x64d * -0x2 + -0x1286, 0x278 + 0x3 * 0x105 + -0x56f],
                    _0x3f581b = [_0x2db296(0x352), _0x2db296(0x238), _0x2db296(0x19b), _0x2db296(0x275), 'arrayBuffer', _0x2db296(0x25f)],
                    _0xcb4d61 = _0x2db296(0x315)[_0x2db296(0x342)](''), _0x5c5e45 = [], _0x54b265;
                if (_0x1edc95) {
                ...
                _0x22f902[_0x2db296(0x344)][_0x2db296(0x2d5)] = function (_0x36f09d) {
                    ...
                    _0x22f902[_0x2db296(0x344)][_0x2db296(0x2ba)] = function () {
                        var _0x2f0149 = _0x2db296, _0x227f23, _0x3952af, _0x2a0c94, _0x39eb64, _0x2fd641, _0x113678,
        ...
        function _0x183951(_0x15f4d9, _0x59200b) {
            var _0x4f373f = _0x5612de, _0x40761a, _0x6155ee = _0x15f4d9[_0x4f373f(0x259)],
        ...
        function _0x3d58e7(_0x5e28f2, _0x468b52) {
            var _0x50c100 = _0x5612de, _0x7c35df, _0x4c97b3, _0x5e0270, _0x3034db, _0x56f817, _0x3084b8,
                _0x66df40 = _0x5e28f2[_0x50c100(0x259)], _0x5506f5 = _0x66df40 - (-0x1c76 + 0x2246 + -0x5cf);
        ...
        function _0x4aaf04(_0x33a7ba, _0x386196) {
            var _0x257c0b = _0x5612de, _0x379288, _0x247a8b, _0x334bb9, _0x2fa83f, _0x417a88,
                _0x2a3ae5 = _0x33a7ba[_0x257c0b(0x259)], _0x429a0d = _0x2a3ae5 - (0xc1 * -0x11 + 0x1f99 + -0xb * 0x1b5);
