...
class bezierTrajectory:
    ...
    def generate_gj(self, slider_x):
        guiji = self.trackArray([4, 0], [slider_x + 10, 2], slider_x + 25, type=0, cbb=0, yhh=2, deviation=10, le=4)[
            'trackArray']
        ...
        for i in guiji:
            ...
            aa = [int(i[0]), int(i[1]), start_time, 1]
            # print(aa)
            guiji_list.append(aa)
        return guiji_list
