...
class JdH5st:
    ...
    def get_data(self):
        ...
        params = {
            ...
            "keyword": "手机",  # 可以换成其他的商品关键字
            "functionId": "pc_search_getShopAndWare",
            "body": self.jd_params,  # 接口请求的body为明文
